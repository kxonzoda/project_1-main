...
class SignUpForm(UserCreationForm):
    ...
    password1 = forms.CharField(
        ...
        widget=forms.PasswordInput(
            attrs={"class": "form-control mb-3", "placeholder": "*********", "autocomplete": "new-password"}),
        help_text="<small>Katta va kichik <b>harflar</b>, <b>raqamlar</b>, <b>8ta</b> belgidan iborat bo'lish karak.</small>",
    )
    ...
    def clean_phone(self):
        ...
        if not phone.isdigit():
            raise ValidationError(
                _("Telefon raqam faqat raqamlardan iborat bo'sin.")
            )
...
class CustomLoginForm(AuthenticationForm):
    phone = forms.CharField(
        ...
        label=_("Telefon"),
        widget=forms.TextInput(
            attrs={'class': 'form-control mb-3', 'placeholder': '93-123-45-67', 'type': "tel"})
    )
